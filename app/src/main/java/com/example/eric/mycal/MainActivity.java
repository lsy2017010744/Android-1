    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.close_item:
                finish();
                break;
            case R.id.BinaryConversion_item:
                Intent intent1 = new Intent(MainActivity.this,Binaryconversion.class);
                startActivity(intent1);
                break;
            case R.id.Zhongliang_item:
                Intent intent2 = new Intent(MainActivity.this,Zhongliang.class);
                startActivity(intent2);
                break;
            case R.id.Jinzhi_item:
                Intent intent3 = new Intent(MainActivity.this,Jinzhi.class);
                startActivity(intent3);
                break;
            case R.id.Shijian_item:
                Intent intent4 = new Intent(MainActivity.this,Shijian.class);
